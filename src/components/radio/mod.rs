...
impl GRadioRef {
    ...
    prop_setter! {
        GRadio{
            ...
            set_radio_background_color(color: String) {|c_ref| {c_ref.radio_background_color.replace(crate::utils::hex_to_vec4(&color)?); Ok(())}},
            set_radio_background_visible(visible: bool) {|c_ref| {c_ref.radio_background_visible = visible; Ok(())}},
            set_radio_hover_color(color: String) {|c_ref| {c_ref.radio_hover_color.replace(crate::utils::hex_to_vec4(&color)?); Ok(())}},
            set_radio_selected_color(color: String) {|c_ref| {c_ref.radio_selected_color.replace(crate::utils::hex_to_vec4(&color)?); Ok(())}},
            ...
            set_radio_border_color(color: String) {|c_ref| {c_ref.radio_border_color.replace(crate::utils::hex_to_vec4(&color)?); Ok(())}},
    ...
    prop_getter! {
        GRadio{
            ...
            get_radio_background_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.background_color)}},
            get_radio_background_visible(bool) {|| true}, {|c_ref| {c_ref.draw_radio.background_visible.to_bool()}},
            get_radio_hover_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.hover_color)}},
            get_radio_selected_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.selected_color)}},
            get_stroke_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.stroke_color)}},
            get_stroke_hover_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.stroke_hover_color)}},
            get_stroke_selected_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.stroke_selected_color)}},
            get_radio_border_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio.border_color)}},
            get_radio_border_width(f32) {|| 1.0}, {|c_ref| {c_ref.draw_radio.border_width}},
            get_scale(f32) {|| 0.48}, {|c_ref| {c_ref.draw_radio.scale}},
            get_background_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio_wrap.background_color)}},
            get_hover_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio_wrap.hover_color)}},
            get_focus_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio_wrap.focus_color)}},
            get_shadow_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio_wrap.shadow_color)}},
            get_border_color(String) {||Default::default()}, {|c_ref| {crate::utils::vec4_to_hex(&c_ref.draw_radio_wrap.border_color)}},
